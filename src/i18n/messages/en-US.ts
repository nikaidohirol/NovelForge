export const enUS = {
  ...
  'app.windowTitle': 'NovelForge — Anime Light Novel Studio',
  ...
  'error.projectRootRequired': 'Select the project root folder that contains .novelforge/project.json, not its parent folder.',
