...
import { normalizeCharacterAnimeCard } from '../shared/character-anime'
...
export function characterRosterEntryFromCard(card: CharacterData): CharacterRosterEntry {
  ...
  return {
    ...
    ...(card.anime ? { anime: normalizeCharacterAnimeCard(card.anime) } : {}),
...
export function characterCardFromRosterEntry(entry: CharacterRosterEntry): CharacterData {
  return {
    ...
    ...(entry.anime ? { anime: normalizeCharacterAnimeCard(entry.anime) } : {}),
  }
}
