...
class SkillRegistryImpl {
  ...
  /** 从主进程管理的用户 Skill 目录加载，渲染进程不接触 NOVELFORGE_HOME 路径。 */
  ...
  private async loadAllAtomic(): Promise<void> {
    ...
    if (
      ...
      const projectSkillsDir = `${projectSession.projectPath}/.novelforge/skills`
...
Use read_project_state first to understand the project's established style. Then give focused advice with a short before-and-after example.`,
    ...
    {
      metadata: {
        name: 'lightnovel-tsukkomi',
        displayName: '轻小说文风 · 吐槽系',
        description: '第一人称吐槽视角：快节奏对话、内心吐槽与反差笑点，适合恋爱喜剧与校园日常。',
        version: '1.0.0',
      },
      content: 'Write in first person with a constant inner tsukkomi (retort) voice. Drive scenes through rapid dialogue exchanges; let the narrator retort in his head between lines. Use contrast and misunderstanding for comedy beats, keep paragraphs short, and land each scene on a punchline or a flustered reaction. Keep the tone light and never let exposition run longer than three sentences before breaking it with a joke.',
      localizedContent: {
        'zh-CN': '以第一人称叙述，保持持续的内心吐槽视角。场景由快节奏对话推动，叙述者在对话间隙于内心吐槽。用反差与误会制造笑点，段落保持短促，每个场景落在一个吐槽点或慌乱反应上。基调轻快，说明性文字不要连续超过三句，必须用玩笑打断。',
        'en-US': 'Write in first person with a constant inner tsukkomi (retort) voice. Drive scenes through rapid dialogue exchanges; let the narrator retort in his head between lines. Use contrast and misunderstanding for comedy beats, keep paragraphs short, and land each scene on a punchline or a flustered reaction.',
      },
      writingSkill: inspectWritingSkillMarkdown(`---\nname: lightnovel-tsukkomi\ndisplay_name: Light Novel Style - Tsukkomi Comedy\ndescription: First-person tsukkomi narration with rapid dialogue-driven comedy.\nversion: 1.0.0\nlanguage: bilingual\nstage: drafting\n---\nFirst-person narration with constant inner retorts; comedy from contrast and misunderstanding; short paragraphs; every scene ends on a punchline.`),
    },
    {
      metadata: {
        name: 'lightnovel-chuuni',
        displayName: '轻小说文风 · 中二热血',
        description: '中二病式宣言与必杀技命名，夸张的战斗演出与燃点独白，适合异能战斗与王道热血。',
        version: '1.0.0',
      },
      content: 'Embrace chuunibyou theatrics: characters declare named special attacks, speak in grandiose proclamations, and treat mundane matters with cosmic significance. Battle scenes get cinematic choreography and escalating stakes; inner monologues burn with resolve. Let the protagonist\'s dramatic claims be half-ridiculous and half-true, and time each power-up or comeback line to land at the chapter climax.',
      localizedContent: {
        'zh-CN': '拥抱中二式演出：角色宣言必杀技名称，用夸张的宣言说话，把平凡小事赋予宏大意义。战斗场景用电影化分镜与层层升级的危机；内心独白燃烧着觉悟。主角的中二发言一半可笑一半成真，把每次爆发或逆袭台词安排在章节高潮落下。',
        'en-US': 'Embrace chuunibyou theatrics: characters declare named special attacks, speak in grandiose proclamations, and treat mundane matters with cosmic significance. Battle scenes get cinematic choreography; inner monologues burn with resolve. Time each power-up or comeback line to land at the chapter climax.',
      },
      writingSkill: inspectWritingSkillMarkdown(`---\nname: lightnovel-chuuni\ndisplay_name: Light Novel Style - Chuunibyou Spectacle\ndescription: Grandiose declarations, named techniques, and burning battle monologues.\nversion: 1.0.0\nlanguage: bilingual\nstage: drafting\n---\nChuunibyou declarations and named special moves; cinematic battle choreography; burning monologues at chapter climaxes.`),
    },
    {
      metadata: {
        name: 'lightnovel-healing',
        displayName: '轻小说文风 · 治愈日常',
        description: '温柔的日常描写与细腻的感官细节，小确幸节奏，适合治愈系与芳文社风格。',
        version: '1.0.0',
      },
      content: 'Write gentle slice-of-life scenes grounded in sensory detail: the warmth of sunlight, the sound of tea being poured, small gestures between friends. Keep conflict low-stakes and resolve it through kindness and understanding. Pace chapters with quiet observation, one small discovery or heartwarming beat per scene, and end on a soft, comforting note that makes the reader exhale.',
      localizedContent: {
        'zh-CN': '以细腻的感官细节构建温柔的日常场景：阳光的温度、倒茶的声音、朋友间的小动作。冲突保持低烈度，通过善意与理解化解。章节以安静的观察推进，每个场景安排一个小小的发现或暖心瞬间，以让人安心呼出一口气的柔软结尾收束。',
        'en-US': 'Write gentle slice-of-life scenes grounded in sensory detail: warmth of sunlight, the sound of poured tea, small gestures between friends. Keep conflict low-stakes and resolve it through kindness. One small discovery or heartwarming beat per scene; end on a soft, comforting note.',
      },
      writingSkill: inspectWritingSkillMarkdown(`---\nname: lightnovel-healing\ndisplay_name: Light Novel Style - Healing Slice of Life\ndescription: Gentle sensory daily-life scenes with low-stakes warmth.\nversion: 1.0.0\nlanguage: bilingual\nstage: drafting\n---\nSensory-grounded slice of life; low-stakes conflict resolved with kindness; one heartwarming beat per scene; soft comforting endings.`),
    },
    {
      metadata: {
        name: 'lightnovel-adventure',
        displayName: '轻小说文风 · 王道冒险',
        description: '使命感驱动的王道展开：队伍羁绊、成长阶梯与层层递进的危机，适合奇幻冒险与升级流。',
        version: '1.0.0',
      },
      content: 'Follow the orthodox adventure arc: a clear goal, escalating trials, and companions whose bonds are tested and deepened. Give each chapter one step of progress (a new ally, a new skill, a revealed map piece) and one new threat. Keep the protagonist\'s growth legible: from powerless outsider to indispensable core. Cliffhangers at chapter ends should promise the next stage of the journey.',
      localizedContent: {
        'zh-CN': '遵循王道冒险弧线：明确的目标、层层升级的试炼、经受考验并加深的同伴羁绊。每章推进一格（新伙伴、新能力、新地图碎片）并引入一个新威胁。让主角的成长清晰可读：从无力旁观者到不可或缺的核心。章末悬念要预告下一段旅程。',
        'en-US': 'Follow the orthodox adventure arc: a clear goal, escalating trials, and companions whose bonds are tested and deepened. One step of progress and one new threat per chapter; legible protagonist growth; cliffhangers promising the next stage.',
      },
      writingSkill: inspectWritingSkillMarkdown(`---\nname: lightnovel-adventure\ndisplay_name: Light Novel Style - Orthodox Adventure\ndescription: Goal-driven adventure with party bonds, growth steps, and escalating threats.\nversion: 1.0.0\nlanguage: bilingual\nstage: drafting\n---\nOrthodox adventure arc; one progress step and one new threat per chapter; clear growth ladder; forward-looking cliffhangers.`),
    },
    {
      metadata: {
        name: 'lightnovel-monologue-craft',
        displayName: '轻小说技法 · 内心独白',
        description: '控制内心独白与台词的比例与节奏，用括号心声与自我吐槽塑造视角人物的可爱感。',
        version: '1.0.0',
      },
      content: 'Balance inner monologue against dialogue: aim for monologue to carry emotion and information between lines, never repeating what a line of dialogue already said. Use short bracketed asides for the viewpoint character\'s unspoken reactions, and vary rhythm so a burst of rapid-fire thoughts is followed by a beat of stillness. Monologue should color events with the narrator\'s bias, not narrate them neutrally.',
      localizedContent: {
        'zh-CN': '平衡内心独白与台词的比例：独白负责在对话间隙传递情绪与信息，绝不复述台词已说明的内容。用简短的括号心声表现视角人物没说出口的反应，节奏要有爆发与停顿的交替。独白要用叙述者的偏见给事件着色，而不是中立转述。',
        'en-US': 'Balance inner monologue against dialogue: monologue carries emotion and information between lines, never repeating what dialogue said. Use short bracketed asides for unspoken reactions; alternate bursts of thought with beats of stillness; let monologue color events with the narrator\'s bias.',
      },
      writingSkill: inspectWritingSkillMarkdown(`---\nname: lightnovel-monologue-craft\ndisplay_name: Light Novel Technique - Inner Monologue\ndescription: Monologue-to-dialogue balance, bracketed asides, and biased narration.\nversion: 1.0.0\nlanguage: bilingual\nstage: refinement\n---\nMonologue between lines without repeating dialogue; bracketed asides for unspoken reactions; biased, colorful narration.`),
    },
    {
      metadata: {
        name: 'lightnovel-flag-craft',
        displayName: '轻小说技法 · 插旗与回收',
        description: '把伏笔写成可辨识的「旗帜」，按轻小说惯例在情绪高点或章节末回收，形成宿命感。',
        version: '1.0.0',
      },
      content: 'Plant flags deliberately: a promise, a death-flag line, a keepsake, or a casual remark that the reader learns to watch. Register each flag in the blueprint notes. Pay them off at emotional peaks or chapter endings, ideally inverted once (the obvious flag does not fire, or fires sideways) to keep the pattern alive. Never leave a major flag unaddressed past its promised chapter window.',
      localizedContent: {
        'zh-CN': '有意识地插旗：一个约定、一句死亡旗帜台词、一件信物、一句读者学会留意的随口话。把每面旗登记进蓝图笔记。在情绪高点或章节末回收，并适度反转一次（显眼的旗没有响，或斜着响）以保持套路的新鲜感。任何大旗都不得拖过承诺的章节窗口。',
        'en-US': 'Plant flags deliberately: a promise, a death-flag line, a keepsake, a casual remark readers learn to watch. Register flags in blueprint notes. Pay them off at emotional peaks or chapter endings, inverting one occasionally; never leave a major flag past its promised window.',
      },
      writingSkill: inspectWritingSkillMarkdown(`---\nname: lightnovel-flag-craft\ndisplay_name: Light Novel Technique - Flag Planting and Payoff\ndescription: Deliberate flag planting, blueprint registration, and payoff at emotional peaks.\nversion: 1.0.0\nlanguage: bilingual\nstage: planning\n---\nPlant recognizable flags and register them; pay off at peaks or chapter ends; occasional inversion; no flag left overdue.`),
    },
  ]
