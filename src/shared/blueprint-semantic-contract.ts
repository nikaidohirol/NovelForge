...
suspenseHook is always required; even without a mystery, state one concrete unresolved decision, threat, renovelforgetion, or consequence that creates forward pressure.
