...
describe('APP_BRAND', () => {
  it('uses NovelForge visible product language', () => {
    expect(APP_BRAND.zhName).toBe('NovelForge')
    expect(APP_BRAND.enName).toBe('NovelForge')
    expect(APP_BRAND.shortName).toBe('NovelForge')
