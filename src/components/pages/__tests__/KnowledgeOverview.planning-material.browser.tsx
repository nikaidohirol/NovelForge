...
const originalNovelForgeAPI = Object.getOwnPropertyDescriptor(window, 'novelforgeAPI')
...
afterEach(async () => {
  ...
  if (originalNovelForgeAPI) Object.defineProperty(window, 'novelforgeAPI', originalNovelForgeAPI)
  else Reflect.deleteProperty(window, 'novelforgeAPI')
})
