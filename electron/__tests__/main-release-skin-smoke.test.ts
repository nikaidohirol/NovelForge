...
vi.mock('../services/release-skin-smoke', () => ({
  ...
  releaseSkinSmokeWasRequested: (args: readonly string[]) => args.some(argument => argument.startsWith('--nf-release-skin-smoke=')),
...
describe('packaged skin smoke startup', () => {
  ...
  beforeEach(() => {
    vi.resetModules()
    process.argv = [...originalArgv, `--nf-release-skin-smoke=${smokeToken}`]
